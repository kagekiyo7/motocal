        ...
        return (
            <div className="profile">
                ...
                <table className="table table-sm table-bordered table-responsive">
                    ...
                    <TextWithTooltip tooltip={intl.translate("LB DAの説明", locale)} id={"tooltip-da-zenith-detail"}><font color="#ffff00">*</font>
                        <tr>
                    ...
                    <TextWithTooltip tooltip={intl.translate("LB TAの説明", locale)} id={"tooltip-ta-zenith-detail"}><font color="#ffff00">*</font>
                        <tr>
                    ...
                    <TextWithTooltip tooltip={intl.translate("LB ダメージ上限UPの説明", locale)} id={"tooltip-ta-zenith-detail"}><font color="#ffff00">*</font>
                        <tr>
                    ...
                    <TextWithTooltip tooltip={intl.translate("LB 奥義の説明", locale)} id={"tooltip-ougidamage-zenith-detail"}><font color="#ffff00">*</font>
                        <tr>
