...
module.exports.calcBasedOneSummon = function (summonind, prof, buff, totals) {
    ...
    for (var key in totals) {
        ...
        if (key == "Djeeta" && totals[key]["ougiTwoTimes"]) {
            ougiDamage += module.exports.calcOugiDamage(summedAttack, totalSkillCoeff, criticalRatio, prof.enemyDefense, prof.defenseDebuff, enemyResistance, totals[key]["ougiRatio2"], ougiDamageUP, damageUP, ougiFixedDamage, totals[key]["ougiBonusPlainDamage"], ougiDamageLimitValues);
        } else if (key != "Djeeta") {
