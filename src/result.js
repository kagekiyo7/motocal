                        ...
                        <table style={{"width": "100%", textAlign: "center", marginBottom: "2px"}}
                            ...
                            <tr>
                                ...
                                <td onClick={this.handleEvent.bind(this, "switchNewCalcTotalDamage")}
                                    className={(this.state.switchNewCalcTotalDamage == 1) ? "display-checked" : "display-unchecked"}> 新予測ダメージ
                                </td>
                    ...
                    <ButtonToolbar>
                        ...
                        <DropdownButton title={intl.translate("予測ダメージ", locale)} id="expected-damage">
                            ...
                            <MenuItem onClick={this.handleEvent.bind(this, "switchNewCalcTotalDamage")}
                                      active={(this.state.switchNewCalcTotalDamage == 1) ? true : false}> {intl.translate("パーティ平均予想ターン毎ダメージ", locale)} </MenuItem>
